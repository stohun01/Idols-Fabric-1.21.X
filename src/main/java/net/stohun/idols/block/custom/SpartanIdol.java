...
public class SpartanIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<SpartanIdol> CODEC = createCodec(SpartanIdol::new);
    ...
    public SpartanIdol(Settings settings) {
        super(settings);
