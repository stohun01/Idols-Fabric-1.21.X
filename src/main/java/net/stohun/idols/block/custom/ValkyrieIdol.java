...
public class ValkyrieIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<ValkyrieIdol> CODEC = createCodec(ValkyrieIdol::new);
    ...
    public ValkyrieIdol(Settings settings) {
        super(settings);
