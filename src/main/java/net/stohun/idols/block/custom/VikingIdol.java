...
public class VikingIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<VikingIdol> CODEC = createCodec(VikingIdol::new);
    ...
    public VikingIdol(Settings settings) {
        super(settings);
