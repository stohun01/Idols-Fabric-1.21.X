...
public class DruidIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<DruidIdol> CODEC = createCodec(DruidIdol::new);
    ...
    public DruidIdol(Settings settings) {
        super(settings);
