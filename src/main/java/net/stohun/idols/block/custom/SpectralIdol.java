...
public class SpectralIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<SpectralIdol> CODEC = createCodec(SpectralIdol::new);
    ...
    public SpectralIdol(Settings settings) {
        super(settings);
