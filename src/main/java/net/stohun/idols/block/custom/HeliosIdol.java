...
public class HeliosIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<HeliosIdol> CODEC = createCodec(HeliosIdol::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(5.0, 0.0, 5.0, 11.0, 11.0, 11.0);

    // Add waterlogged property
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public HeliosIdol(Settings settings) {
        super(settings);
