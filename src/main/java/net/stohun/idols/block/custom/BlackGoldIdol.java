...
public class BlackGoldIdol extends HorizontalFacingBlock implements Waterloggable {
    public static final MapCodec<BlackGoldIdol> CODEC = createCodec(BlackGoldIdol::new);
    ...
    public BlackGoldIdol(Settings settings) {
        super(settings);
